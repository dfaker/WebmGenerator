...
class SessionProperties():
  def __init__(self):
    ...
    self.cycles = [
      {'key':'1','text':'FPS Max {} [1]',           'cycle':['24','30','60','None'],                 'default':'None', 'prop':'fpsLimit'},
      {'key':'2','text':'Size Max {} [2]',          'cycle':['4M','6M','20M','None'],                'default':'None',  'prop':'sizeLimit'},
      ...
      {'key':'5','text':'Max Width {} [5]',         'cycle':['720','1280','1920','None'],            'default':'1920', 'prop':'maxVWidth'},
